...
@section('page-title', 'Masse Salariale Non Payée par Spécialité')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Masse Salariale Non Payée par Spécialité</h2>
            <p class="text-gray-600 mt-1">Estimation des montants à payer par spécialité</p>
        </div>
        <a href="{{ route('admin.rapports.masse-non-payes-specialite.export', request()->query()) }}" class="px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg transition">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="{{ route('admin.rapports.masse-non-payes-specialite') }}" class="grid grid-cols-1 md:grid-cols-1 gap-4">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.rapports.masse-non-payes-specialite') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition">
