...
@section('title', 'Nouveau Vacataire')
@section('page-title', 'Créer un Vacataire')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Nouveau Enseignant Vacataire</h3>
            <p class="text-sm text-gray-600 mt-1">Créer un nouveau compte pour un enseignant vacataire</p>
        </div>

        <form action="{{ route('admin.vacataires.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-blue-800">Mot de passe par défaut</p>
                        <p class="text-sm text-blue-700 mt-1">
                            Le mot de passe par défaut sera : <strong>password123</strong>
                        </p>
                        <p class="text-xs text-blue-600 mt-1">
                            Le vacataire pourra le changer lors de sa première connexion
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition font-medium">
                    <i class="fas fa-save mr-2"></i> Créer le Vacataire
                </button>
            </div>
        </form>
    </div>
