                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="attendance_mode" id="attendance_mode"
                                ...
                                <option value="standard" {{ old('attendance_mode') === 'hospital' ? '' : 'selected' }}>Standard (horaires fixes)</option>
                                <option value="hospital" {{ old('attendance_mode') === 'hospital' ? 'selected' : '' }}>Hopital (jour + garde de nuit)</option>
                            </select>
                        ...
                        <div id="hospital-fields" style="display: none;" class="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="time" name="night_start_time" id="night_start_time" value="{{ old('night_start_time', '19:00') }}"
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="night_late_tolerance" id="night_late_tolerance" value="{{ old('night_late_tolerance', 15) }}" min="0" max="60"
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                        </div>
